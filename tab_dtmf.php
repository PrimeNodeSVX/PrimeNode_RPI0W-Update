...
<div class="dtmf-columns">
    <div class="panel-box">
        ...
        <div class="dtmf-tabs">
            <div class="dtmf-tab-btn active" id="tab-btn-PrimeNode" onclick="openDtmfSubTab('PrimeNode')"><?php echo $DT[$lang]['tab_primenode']; ?></div>
            <div class="dtmf-tab-btn" id="tab-btn-Mine" onclick="openDtmfSubTab('Mine')"><?php echo $DT[$lang]['tab_mine']; ?></div>
        </div>

        <div id="DTMF-PrimeNode" class="dtmf-subtab" style="display:block;">
