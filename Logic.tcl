...
proc dtmf_cmd_received {cmd} {
  ...
  #  return 1
  #}
  if {[regexp {^555(\d+)$} $cmd -> net_id]} {
      puts ">>> DTMF: Przelaczanie na siec ID: $net_id"
      ...
      catch {playMsg "Core" "online"}
      catch {exec sudo /usr/bin/python3 /usr/local/bin/dtmf_switch.py $net_id &}
      return 1
  }
